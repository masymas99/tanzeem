...
<head>
    ...
    .delete-icon i, .edit-icon i, .icon-print i {
        ...
        <div class="filter-container">
            <form method="GET" action="{{ route('attendance.index') }}" class="mb-5 w-75">
                ...
                <div class="col-md-1 text-center">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="name" class="form-control search-input text-end w-100 custom-input" placeholder="ابحث باسم الموظف" value="{{ request('name') }}">
                    </div>
    ...
    <div class="modal-content modal-custom">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('attendance.store') }}">
                    ...
                    <input type="time" name="check_in_time" class="form-control mb-2 custom-input"required>

                    <label class="text-end w-100">وقت الانصراف</label>
                    <input type="time" name="check_out_time" class="form-control mb-2 custom-input" required>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 25px; overflow: hidden;">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary rounded-4" data-bs-dismiss="modal">إلغاء</button>
...
<div class="modal fade" id="editAttendanceModal{{ $attendance->id }}" tabindex="-1" aria-labelledby="editAttendanceModalLabel{{ $attendance->id }}" aria-hidden="true">
    ...
    <div class="modal-content modal-custom">
    <div class="modal-header text-center w-100">
                <h5 class="modal-title text-center w-100 fw-bold" id="editAttendanceModalLabel{{ $attendance->id }}" >تعديل الحضور</h5>
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('attendance.update', $attendance->id) }}">
                    ...
                    <label class="text-end w-100">التاريخ</label>
                    <input type="date" name="date" class="form-control mb-2 custom-input" value="{{ $attendance->date }}"required>

                    <label class="text-end w-100">وقت الحضور</label>
                    <input type="time" name="check_in_time" class="form-control mb-2 custom-input" value="{{ $attendance->check_in_time }}"required>

                    <label class="text-end w-100">وقت الانصراف</label>
                    <input type="time" name="check_out_time" class="form-control mb-2 custom-input" value="{{ $attendance->check_out_time }}" required>
