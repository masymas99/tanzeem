                ...
                <div class="bg-gradient-to-br from-white to-gray-50 shadow-lg rounded-2xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="mr-5 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-600">المرتب الصافي</dt>
                                    <dd class="flex items-baseline">
                                        <div class="text-3xl font-bold text-gray-900">{{ number_format($stats['netSalary']) }}</div>
                                    </dd>
                                </dl>
                            </div>
                        </div>
                ...
                <div class="bg-gradient-to-br from-white to-gray-50 shadow-lg rounded-2xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="mr-5 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-600">إجمالي المرتبات</dt>
                                    <dd class="flex items-baseline">
